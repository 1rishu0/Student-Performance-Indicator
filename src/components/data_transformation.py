...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            num_pipeline=Pipeline(
                steps=[
                    ("imputer",SimpleImputer(strategy="median")),# to deal with outliers
    ...
    def intitiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(f"Applying Preprocessing object on training Dataframe and Training Dataframe.")
            ...
            # This code snippet horizontally concatenates (np.c_[]) two arrays: input_feature_train_arr and target_feature_train_df, combining them into a single array, train_arr.
            train_arr=np.c_[
